...
class mpjpe_error(nn.Module):
  def __init__(self):
    super().__init__()
  
  def forward(self, batch_pred, batch_gt):
    batch_pred = batch_pred.reshape(-1,24,3)
    batch_gt = batch_gt.reshape(-1,24,3)
