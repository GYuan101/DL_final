...
from fairmotion.utils import utils as root_utils
...
def save_motion_files(seqs_T, args):
    ...
    root_utils.create_dir_if_absent(os.path.join(args.save_output_path, "ref"))
    root_utils.create_dir_if_absent(os.path.join(args.save_output_path, "pred"))
